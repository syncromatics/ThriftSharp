...
namespace ThriftSharp.Internals
{
    ...
    {
        private static readonly ConcurrentDictionary<TypeInfo, ThriftStruct> _knownStructs =
            new ConcurrentDictionary<TypeInfo, ThriftStruct>();

        private static readonly ConcurrentDictionary<TypeInfo, ThriftService> _knownServices =
            new ConcurrentDictionary<TypeInfo, ThriftService>();
        ...
        private static ThriftField ParseField(PropertyInfo propertyInfo)
        {
            ...
            return new ThriftField(attr.Id, attr.Name, attr.IsRequired, attr.DefaultValue, attr.ThriftConverter,
                propertyInfo);
        }
        ...
        private static ThriftParameter ParseMethodParameter(ParameterInfo parameterInfo)
        {
            ...
            return new ThriftParameter(attr.Id, attr.Name, parameterInfo.ParameterType.GetTypeInfo(),
                attr.ThriftConverter);
        }
        ...
        private static ThriftMethod ParseMethod(MethodInfo methodInfo)
        {
            ...
            return new ThriftMethod(attr.Name, attr.IsOneWay,
                new ThriftReturnValue(unwrapped.GetTypeInfo(), attr.ThriftConverter), throwsClauses, parameters);
        }
